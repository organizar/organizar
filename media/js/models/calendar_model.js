	...
	function render(date) {
		...
		if (! found_a_event) {
			...
			$.each(events, function(key, event) {
				...
				console.log("end_time_hours " + end_time_hours + " start time ", start_time);
				console.log("end_time_minutes " + end_time_minutes + " end_time ", end_time);
				...
				height = parseInt(extra_height) - 10;
